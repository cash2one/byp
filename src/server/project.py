...
bdkv_slns = [
	...
	['bdlogicutils','产品中间层组件','杨彦召','middle','client_proj',[]],
	['bdmclient','产品中间层组件','杨彦召','middle','client_proj',[]],
	['bdmcommondll','公共dll库','刘恒','base','common_proj',[]],
	...
	['bdmantivirus','杀毒模块','赵欣','module','antivirus_proj',[]],
...
bdm_slns = [
	...
	['bdmsysaccelerator','系统加速','赫卫卿','module','system_proj',[]],
	['bdmsoacceleratorplugin','软件优化加速插件','赫卫卿','module','system_proj',[]],
	['bdmsocleanerplugin','系统优化清理插件','张巍','module','system_proj',[]],
	['bdmsomanager','软件优化管家','张凯','module','system_proj',[]],
	['bdmsoshortcutplugin','软件优化快捷插件','张凯','module','system_proj',[]],
	['bdmswmanager','软件管理','张凯','module','system_proj',[]],
	['qmlib','qmlib是什么','张巍','middle','qmold_proj',[]],
	['qmgarbagecleaner','垃圾清理','张巍','module','qmold_proj',[]],
	['bdmhomepageplugins','主页插件','杨彦召','module','main_proj',[]],
	['bdmmainframeplugins','框架插件','杨彦召','module','main_proj',[]],
	['bdmmain','极光主程序','杨彦召','module','main_proj',[]],
]
