...
cron_tasks = {
             kv_release_without_tag : "{\"msrc\":\"ws-btn-build\",\"content\":\"|X光|commonlib,1;commondll,1;skin,1;logicmisc,1;logicutils,1;client,1;avcommon,1;filemon,1;avhips,1;drivermanager,1;sysrepair,1;antivirus,1;bdkv,1;bd0001,1|svn,3;prebuild,2;locksvn,0;rewriteversion,1;buildtype,2;sign,1;ignorefault,0;build,2;install,1;pack,1;symadd,1;signinstaller,1;send,1;releasesvn,0;commit,1|markupcode,0|markupdetail,byp_$r_$v_$t|reason,daily build|email,sw@baidu.com|codebase,3|cbdetail,code base[optional]\"}",
             kv_release_with_tag : "{\"msrc\":\"ws-btn-build\",\"content\":\"|X光|commonlib,1;commondll,1;skin,1;logicmisc,1;logicutils,1;client,1;avcommon,1;filemon,1;avhips,1;drivermanager,1;sysrepair,1;antivirus,1;bdkv,1;bd0001,1|svn,3;prebuild,2;locksvn,0;rewriteversion,1;buildtype,2;sign,1;ignorefault,0;build,2;install,1;pack,1;symadd,1;signinstaller,1;send,1;releasesvn,0;commit,1|markupcode,2|markupdetail,byp_$r_$v_$t|reason,daily build|email,sw@baidu.com|codebase,3|cbdetail,code base[optional]\"}",
             mgr_full_without_tag : "{\"msrc\":\"ws-btn-build\",\"content\":\"|极光|commonlib,1;commondll,1;skin,1;logicmisc,1;logicutils,1;client,1;syscleaner,1;soacceleratorplugin,1;swmanager,1;main,1;trojanscan,1;antivirusGJ,1;drivermanager,1;avhips,1;bd0001,1|svn,3;prebuild,2;locksvn,0;rewriteversion,1;buildtype,3;sign,1;ignorefault,0;build,2;install,1;pack,1;symadd,1;signinstaller,1;send,1;releasesvn,0;commit,1|markupcode,0|markupdetail,byp_$r_$v_$t|reason,daily build|email,sw@baidu.com|codebase,3|cbdetail,code base[optional]\"}",
             mgr_full_with_tag : "{\"msrc\":\"ws-btn-build\",\"content\":\"|极光|commonlib,1;commondll,1;skin,1;logicmisc,1;logicutils,1;client,1;syscleaner,1;soacceleratorplugin,1;swmanager,1;main,1;trojanscan,1;antivirusGJ,1;drivermanager,1;avhips,1;bd0001,1|svn,3;prebuild,2;locksvn,0;rewriteversion,1;buildtype,3;sign,1;ignorefault,0;build,2;install,1;pack,1;symadd,1;signinstaller,1;send,1;releasesvn,0;commit,1|markupcode,2|markupdetail,byp_$r_$v_$t|reason,daily build|email,sw@baidu.com|codebase,3|cbdetail,code base[optional]\"}",
