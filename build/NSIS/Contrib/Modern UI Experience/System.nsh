...
!macro MUI_INTERFACE
	...
	!ifdef MUI_SKIN
		!include  "${MUI_XP_DIR}\Skins\${MUI_SKIN}\skin.nsh"
	!endif 
	...
	!insertmacro MUI_DEFAULT MUI_UNWELCOMEFINISHPAGE_INI "${MUI_WELCOMEFINISHPAGE_INI}"
	...
	!ifdef MUI_BGGRADIENT & MUI_TEXT_COLOR & MUI_TEXT_BGCOLOR & MUI_TEXT_LIGHTCOLOR
...
!macro MUI_FUNCTION_WELCOMEPAGE PRE LEAVE
  ...
  Function "${PRE}"
    ...
    !ifmacrodef MUI_WELCOME_MACROPRE
    ...
    !ifmacrodef MUI_WELCOME_MACROSHOW
  ...
  Function "${LEAVE}"
    ...
    !ifmacrodef MUI_WELCOME_MACROLEAVE
    !insertmacro MUI_WELCOME_MACROLEAVE
    !endif
...
!macro MUI_FUNCTION_LICENSEPAGE PRE SHOW LEAVE
  ...
  Function "${PRE}"
    ...
    !ifmacrodef MUI_LICENSE_MACROPRE
    !insertmacro MUI_LICENSE_MACROPRE
    !endif
  ...
  Function "${SHOW}"
    ...
    !ifmacrodef MUI_LICENSE_MACROSHOW
    !insertmacro MUI_LICENSE_MACROSHOW
    !endif
  ...
  Function "${LEAVE}"
    ...
    !ifmacrodef MUI_LICENSE_MACROLEAVE
    !insertmacro MUI_LICENSE_MACROLEAVE
    !endif
...
!macro MUI_FUNCTION_COMPONENTSPAGE PRE SHOW LEAVE
  ...
  Function "${PRE}"
    !ifmacrodef MUI_COMPONENTS_MACROPRE
    !insertmacro MUI_COMPONENTS_MACROPRE
    !endif
  ...
  Function "${SHOW}"
    ...
    !ifmacrodef MUI_COMPONENTS_MACROSHOW
    !insertmacro MUI_COMPONENTS_MACROSHOW
    !endif
  ...
  Function "${LEAVE}"
    ...
    !ifmacrodef MUI_COMPONENTS_MACROLEAVE
    !insertmacro MUI_COMPONENTS_MACROLEAVE
    !endif
...
!macro MUI_FUNCTION_DIRECTORYPAGE PRE SHOW LEAVE
  ...
  Function "${PRE}"
    !ifmacrodef MUI_DIRECTORY_MACROPRE
    !insertmacro MUI_DIRECTORY_MACROPRE
    !endif
  ...
  Function "${SHOW}"
    ...
    !ifmacrodef MUI_DIRECTORY_MACROSHOW
    !insertmacro MUI_DIRECTORY_MACROSHOW
    !endif
  ...
  Function "${LEAVE}"
    !ifmacrodef MUI_DIRECTORY_MACROLEAVE
    !insertmacro MUI_DIRECTORY_MACROLEAVE
    !endif
...
!macro MUI_FUNCTION_INSTFILESPAGE PRE SHOW LEAVE
  ...
  Function "${PRE}"
    ...
    !ifmacrodef MUI_INSTFILES_MACROPRE
    !insertmacro MUI_INSTFILES_MACROPRE
    !endif
  ...
  Function "${SHOW}"
    ...
    !ifmacrodef MUI_INSTFILES_MACROSHOW
    !insertmacro MUI_INSTFILES_MACROSHOW
    !endif
  ...
  Function "${LEAVE}"
    ...
    !ifmacrodef MUI_INSTFILES_MACROLEAVE
    !insertmacro MUI_INSTFILES_MACROLEAVE
    !endif
...
!macro MUI_FUNCTION_FINISHPAGE PRE LEAVE
  ...
  !insertmacro MUI_INSTALLOPTIONS_WRITE "ioSpecial.ini" "Field 3" Top 65
	...
	!ifmacrodef MUI_FINISH_MACROPRE
	!insertmacro MUI_FINISH_MACROPRE
	!endif
    ...
    !ifdef MUI_FINISHPAGE_RUN & MUI_TEXT_COLOR & MUI_TEXT_BGCOLOR
      GetDlgItem $MUI_TEMP1 $MUI_HWND 1203
      SetCtlColors $MUI_TEMP1 ${MUI_TEXT_COLOR} ${MUI_TEXT_BGCOLOR}
    !endif

    !ifdef MUI_FINISHPAGE_SHOWREADME & MUI_TEXT_COLOR & MUI_TEXT_BGCOLOR
      !ifndef MUI_FINISHPAGE_RUN
        GetDlgItem $MUI_TEMP1 $MUI_HWND 1203
      !else
        GetDlgItem $MUI_TEMP1 $MUI_HWND 1204
    ...
    !ifdef MUI_FINISHPAGE_LINK & MUI_TEXT_COLOR & MUI_TEXT_BGCOLOR
      !ifdef MUI_FINISHPAGE_RUN & MUI_FINISHPAGE_SHOWREADME
	...
	!ifmacrodef MUI_FINISH_MACROSHOW
	!insertmacro MUI_FINISH_MACROSHOW
	!endif
  ...
  Function "${LEAVE}"
	...
	!ifmacrodef MUI_FINISH_MACROLEAVE
	!insertmacro MUI_FINISH_MACROLEAVE
	!endif
